...
export class MensEyeglassesCatalog {
    ...
    applySizeFilter() {
        ...
        cy.wait(2000)
        cy.get('.clear_all_selected_facets').should('be.visible').should('contain.text', 'Reset All Filters').click() //Reset All Filters
        cy.wait(3000)
    ...
    applyFrameMaterialFilter() {
        const randomNumber = reuseableCode.getRandomNumber(0, 12) //Generate a random number 0-13
